        ...
        <div className="space-y-4 rounded-lg border p-4">
          ...
          <div className="space-y-2">
            ...
            {fieldErrors.organization_name && (
              <p className="text-xs text-destructive">{fieldErrors.organization_name[0]}</p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <div className="relative flex-1">
                ...
                <div className="absolute inset-y-0 right-2 flex items-center">
                  ...
                  {!checkingSubdomain && subdomainAvailable === true && <Check className="h-4 w-4 text-emerald-500" />}
            ...
            {subdomainAvailable === false && (
              <p className="text-xs text-destructive">This subdomain is not available</p>
            )}
            {fieldErrors.subdomain && (
              <p className="text-xs text-destructive">{fieldErrors.subdomain[0]}</p>
            )}
          </div>
        </div>
        ...
        <div className="space-y-4 rounded-lg border p-4">
          ...
          <div className="space-y-2">
            ...
            {fieldErrors.admin_name && (
              <p className="text-xs text-destructive">{fieldErrors.admin_name[0]}</p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            {fieldErrors.admin_email && (
              <p className="text-xs text-destructive">{fieldErrors.admin_email[0]}</p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            {fieldErrors.admin_phone && (
              <p className="text-xs text-destructive">{fieldErrors.admin_phone[0]}</p>
            )}
          </div>
