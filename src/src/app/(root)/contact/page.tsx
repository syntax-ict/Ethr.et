 ...
 *
 * `/contact` was the real page until the locale prefix landed; links to it exist in
 * the auth screens, in e2e specs and potentially in anyone's bookmarks. It now
 * forwards to `/am/contact` or `/en/contact`.
 *
...
export const metadata: Metadata = {
  ...
  alternates: alternatesFor("/contact", null),
};
