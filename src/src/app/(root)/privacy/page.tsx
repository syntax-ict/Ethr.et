 ...
 *
 * `/privacy` was the real page until the locale prefix landed; links to it exist in
 * the auth screens, in e2e specs and potentially in anyone's bookmarks. It now
 * forwards to `/am/privacy` or `/en/privacy`.
 *
...
export const metadata: Metadata = {
  ...
  alternates: alternatesFor("/privacy", null),
};
