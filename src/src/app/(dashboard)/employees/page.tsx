                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b bg-muted/50">
                      ...
                      <th className="hidden px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-muted-foreground sm:table-cell">Department</th>
                      <th className="hidden px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-muted-foreground lg:table-cell">Position</th>
                  ...
                  <tbody>
                    {data.data.map((employee) => {
                      ...
                      return (
                        <tr key={employee.public_id} className="border-b last:border-0 transition-colors hover:bg-muted/30">
