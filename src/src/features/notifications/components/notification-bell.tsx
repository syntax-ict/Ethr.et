...
import { useNotifications, useUnreadCount, useMarkAsRead, useMarkAllAsRead } from '../api';
      ...
      <PopoverContent align="end" className="w-80 p-0">
        ...
        {notifications.length === 0 ? (
          ...
          <div className="max-h-80 overflow-y-auto">
            {notifications.map((n: { id: string; data: Record<string, unknown>; read_at: string | null; created_at: string }) => (
              <button
                key={n.id}
                className={cn(
