...
return [
    ...
    // Keep this false. ETHR handles payroll, bank details and national IDs; PII must be
    // opted into per field, never shipped by default.
    'send_default_pii' => env('SENTRY_SEND_DEFAULT_PII', false),

    // Last gate before an event leaves the process: redacts credentials, bank account
    // numbers, national IDs and TINs out of the payload, and tags the owning tenant.
    // Declared as a [class, method] callable (not a closure) so `config:cache` works.
